...
function PropertyDetailPage() {
    ...
    // Helper: Fixes "SingleFamilyResidence" -> "Single Family Residence"
    ...
    return (
        <div className="property-detail-page">
            ...
            <div className="property-header">
                ...
                {/* Mapped: UnparsedAddress -> L_Address */}
                ...
                <div className="property-main">
                    ...
                    <div className="property-section">
                        ...
                        <div className="detail-grid">
                            ...
                            {/* Logic: Don't show Subtype if it's identical to Type */}
                            {property.PropertySubTypeAdditional && property.PropertySubTypeAdditional !== property.L_Type_ && (
                                <div className="detail-item">
                                    <span className="detail-label">Property Subtype:</span>
                                    <span className="detail-value">{formatPascalCase(property.PropertySubTypeAdditional)}</span>
                                </div>
                            )}
                            ...
                            {/* Logic: Don't show row if value is 0 */}
                            {property.L_Keyword5 > 0 && (
                                <div className="detail-item">
                            ...
                            <div className="open-houses-list">
                                {openHouses.map((oh, index) => (
                                    <div key={index} className="open-house-item">
                                        ...
                                        {/* Mapped: Standardizing OH time fields */}
