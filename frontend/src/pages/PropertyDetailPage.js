                        ...
                        <div className="detail-grid">
                            ...
                            {property.PropertySubTypeAdditional && (
                                <div className="detail-item">
                                    ...
                                    <span className="detail-value">{property.PropertySubTypeAdditional}</span>
                                </div>
                            )}
                            {property.LotSizeUnits && (
                                <div className="detail-item">
                                    <span className="detail-label">Lot Size:</span>
                                    <span className="detail-value">{property.LotSizeUnits} acres</span>
                                </div>
                            )}
                            ...
                            <div className="open-houses-list">
                                {openHouses.map((oh, index) => (
                                    <div key={index} className="open-house-item">
                                        ...
                                        {oh.all_data && (
                                            <div className="oh-remarks">{oh.all_data}</div>
                                        )}
                                    </div>
                                ))}
                            </div>
